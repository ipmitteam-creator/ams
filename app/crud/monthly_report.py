...
# === CONFIG ===
INPUT_FOLDER = r"C:\path\to\your\input\files"  # Change this to folder with input files
TEMPLATE_FILE = r"C:\path\to\Jatha_Attendance_Bhati_Beas May 2025.xlsx"
OUTPUT_FILE = r"C:\path\to\Final_Jatha_Attendance.xlsx"
...
for file in os.listdir(INPUT_FOLDER):
    if file.endswith(".xlsx") and "Jatha_Attendance" not in file:
